...
### FUNCTIONS
def process(Print: bool = True, save: bool = False, stations:list[str]=None):
    """
    ...
    """
    ...
    for file in csv_files:
        ...
        if stations is None or station_name in stations:
            # Read csv
            df = pd.read_csv(file)
            ...
            if save:
                ...
                output_path = os.path.join(f"ProcessedReports", new_name)
